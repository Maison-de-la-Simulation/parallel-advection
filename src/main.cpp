...
// ==========================================
void
distr_advection(celerity::distr_queue &Q,
                celerity::buffer<double, 2> &buff_fdistrib,
                DistrAdvector advector,
...
// #endif
    ...
    params.print(); //TODO : only on host
    ...
    celerity::buffer<double, 2> buff_fdistrib(celerity::range<2>(nVx, nx));
    fill_distr_buffer(Q, buff_fdistrib, params);
    ...
    validate_distr_result(Q, buff_fdistrib, params);
