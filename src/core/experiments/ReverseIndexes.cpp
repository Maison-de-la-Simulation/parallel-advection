...
sycl::event
AdvX::ReverseIndexes::operator()(sycl::queue &Q, double *fdist_dev,
    ...
    const sycl::range nb_wg{n2, 1, n0};
        ...
        cgh.parallel_for_work_group(nb_wg, wg_size, [=](sycl::group<3> g) {
            g.parallel_for_work_item(
                sycl::range{1, n1, 1}, [&](sycl::h_item<3> it) {
                    ...
                    const int i0 = g.get_group_id(2);
                    const int i2 = g.get_group_id(0);
            ...
            g.async_work_group_copy(
                sycl::multi_ptr<double,
                    ...
                    fdist_dev) +
                    g.get_group_id(0) + g.get_group_id(2) * n2 * n1, /* dest */
